...
# ══════════════════════════════════════════════════════════════════════════════
# COLLAPSE PRECOMPUTE — EXERCISE_STYLE=0, SM80 pointer stores
# ══════════════════════════════════════════════════════════════════════════════
@triton.jit
    ...
    for step_idx in range(NUM_TIME_STEPS):
        ...
        for j in tl.static_range(NUM_ASSETS):
            if USE_ANTITHETIC:
                ...
                rng_j = MC_OFFSET_PHILOX + j * NUM_TIME_STEPS * TOTAL_NUM_PATHS + actual_path_offs * NUM_TIME_STEPS + step_idx
                Z_j = tl.randn(seed, rng_j)
...
# ══════════════════════════════════════════════════════════════════════════════
# PER-ASSET PRECOMPUTE — EXERCISE_STYLE=1
# ══════════════════════════════════════════════════════════════════════════════
@triton.jit
...
# ══════════════════════════════════════════════════════════════════════════════
# UNIFIED BASKET PAYOFF — SM80 (no TMA)
# ══════════════════════════════════════════════════════════════════════════════
